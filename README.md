...
> **Code Director** is a research and product blueprint for an intent-locked AI agent system. It shifts the paradigm from *generating more code* to *trusting generated code*. 
...
2. **The Verification Layer**: Compiles intent into an enforceable contract — an **Intent Lock** — and reports every outcome with typed evidence. 
...
* 🛡️ **[`codedirector/`](./codedirector/)**: The core CLI package. This contains the scope enforcement mechanisms, the verification engine, and the Intent Lock model.
